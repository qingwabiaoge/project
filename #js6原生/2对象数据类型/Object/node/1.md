...
* 通过构造函数里this.xx创建的键(语法糖{xx:1}),这些属性是自己并非从原型链copy而来的

* Object.creat({原型对象},{"a":{value :1,congigurable :false,enumerable :true,writable:true}})
...
实例copy了Object.protype添加了fn.prototype专有的属性
...
从上图可以实例copy了Object.prototype和Array.prototype,还写了自己专有的hasown属性,'0':1,'1':1,'2',3,length:3
