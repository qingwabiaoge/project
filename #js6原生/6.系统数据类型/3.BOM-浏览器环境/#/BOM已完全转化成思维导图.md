...
##### history.pushState(state:Object,title:String,address?:String)
...
##### URL.createObjectURL(obj：fileType)   
...
#####  sessionStorage.setItem(name:string,jsonString:string)/sessionStorage.getItem(name:string)

```js
  const jsonString = JSON.stringify({a: 1, b: 2})
  sessionStorage.setItem('obj', jsonString);

  const json2 = sessionStorage.getItem('obj')
  console.log(JSON.parse(json2))
```

## localStorage

##### localStorage.setItem(name:string,jsonString:string)/localStorage.getItem(name:string)

```js
  const json1 = JSON.stringify({a: 1, b: 2})
  localStorage.setItem('obj', json1);

  const json2 = localStorage.getItem('obj')
  console.log(JSON.parse(json2))
```
