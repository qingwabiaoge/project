...
|                             |                                                              |                                     |
| --------------------------- | ------------------------------------------------------------ | ----------------------------------- |
| __普通函数体:__相同的部分   | __构造函数函数体:__实例化对象们共同属性不同属性值的语句,this.mame=name<br />__共同的原型属性__prototype | __less-mixin函数体:__重复使用的代码 |
...
obj.toString:toString(){}的this被赋值为obj

等价写法 Object.protorype.toString(obj):toString(){}的this被赋值为obj
