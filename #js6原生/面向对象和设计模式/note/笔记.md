...
- new+Function实例  生成指定格式的Object类型实例
...
- Function类型实例和Function属于Object类型
...
function MidStu() {
    ...
    this.stu = Stu;  //#2  {}.stu=Stu
    
    this.stu();  //#3  {stu:Stu}.stu( )
    delete this.stu;// 删除对象的引用。
}



//#1  new MidStu( )====MidStu.call(new Objcect())===MidStu.call({})
var stu1 = new MidStu();
