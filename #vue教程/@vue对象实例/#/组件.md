...
| dom                                        | Cl                                                           | 构造函数fn Cl(prop,fn)                                       |
| ------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 类div  (HTMLDivElement是div的父类)         | 类Cl    (Vue是Cl的父类)                                      | function Cl(type,update){this.type=type}<br />Cl.prototype=Vue.prototype |
|                                            | CL子组件里的data变量                                         | function Cl(type){<br />this.type=type<br />var data=msg<br /> btn( )} |
| <div></div>是构造函数div实例化             | <cl></cl>       构造函数Cl实例化                             | [new Cl( )](#new)                                            |
